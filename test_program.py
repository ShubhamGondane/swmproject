...
#print(train_data)
tweet_list=train_data['SentimentText'].tolist()
sentiment_list=train_data['Sentiment'].tolist()

for x in range(0,len(tweet_list)):
        documents.append((tweet_list[x],sentiment_list[x]))
        r=tweet_list[x]
        r = re.sub(r'http\S+', " ",r)
...
training_set=featuresets[:70000]
testing_set=featuresets[70000:]
